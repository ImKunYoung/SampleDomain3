...
@RestController
@RequestMapping("/api/sample-domain-3-kafka")
public class SampleDomain3KafkaResource {

    private final Logger log = LoggerFactory.getLogger(SampleDomain3KafkaResource.class);
    ...
    public SampleDomain3KafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
